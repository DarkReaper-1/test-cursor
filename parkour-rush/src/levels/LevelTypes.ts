...
export const THEMES: Record<LevelTheme, ThemePalette> = {
  rooftop: {
    ...
    boost: 0xffdd00, launch: 0x118ab2, breakable: 0xc9a227, prop1: 0x718096, prop2: 0x4a5568,
  ...
  construction: {
    ...
    boost: 0xffe14d, launch: 0x264653, breakable: 0xddb892, prop1: 0xbc6c25, prop2: 0x606c38,
  ...
  street: {
    ...
    boost: 0xffe14d, launch: 0x0077b6, breakable: 0xffba08, prop1: 0x778da9, prop2: 0x415a77,
  ...
  industrial: {
    ...
    boost: 0xffd60a, launch: 0x277da1, breakable: 0xbf9b30, prop1: 0x4d5d6d, prop2: 0x37424d,
  ...
  bridge: {
    ...
    boost: 0xffdd00, launch: 0x3a86ff, breakable: 0xe9c46a, prop1: 0x6d597a, prop2: 0x355070,
  ...
  sunset: {
    ...
    boost: 0xffdd00, launch: 0x4361ee, breakable: 0xe8a536, prop1: 0x5c548c, prop2: 0x413d66,
  ...
  night: {
    ...
    boost: 0xffe14d, launch: 0x4cc9f0, breakable: 0xf9c74f, prop1: 0x232b4d, prop2: 0x171e38,
