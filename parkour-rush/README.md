...
![gameplay](https://img.shields.io/badge/engine-three.js-blue) ![tests](https://img.shields.io/badge/tests-44%20passing-brightgreen)
...
- **Pickups**: instanced coins (magnet-aware) and 5 power-ups (Speed Surge, Shield, Coin Magnet, Slow-Mo, Air Boost) with HUD timers, VFX and audio.
...
- **Characters**: 5 original procedural runners with distinct palettes/proportions, accent colors, and 6 trail cosmetics.
...
- **UI**: boot, main menu, level select (stars/best times/locks), customization shop, settings, gameplay HUD (position, timer, progress, coins, power-ups, pause), pause menu, results/rewards screen, contextual first-run tutorial prompts.
